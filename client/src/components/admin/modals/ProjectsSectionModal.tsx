                        ...
                        <div>
                            ...
                            <div className="flex gap-2 mb-6">
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg text-sm transition-colors ${projectTypeFilter === 'all'
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg text-sm transition-colors flex items-center gap-2 ${projectTypeFilter === 'photo'
                                            ? 'bg-blue-600 text-white'
                                            : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg text-sm transition-colors flex items-center gap-2 ${projectTypeFilter === 'video'
                                            ? 'bg-blue-600 text-white'
                                            : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600'
                                        }`}
                                >
