...
export default function EditMaintenancePageClient() {
  ...
  useEffect(() => {
    const loadOptions = async () => {
      try {
        ...
        logger.error('Bakım düzenleme seçenekleri yüklenemedi:', metaError);
      }
    };
    ...
    const fetchMaintenance = async () => {
      ...
      try {
        ...
        setFormData({
          equipmentId,
          type,
          priority: mapBackendMaintenancePriorityToFrontend(data.priority) as MaintenanceForm['priority'],
