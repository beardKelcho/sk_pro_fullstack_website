...
export default function Home() {
  ...
  return (
    <MainLayout>
        ...
        <div className="container mx-auto px-4 relative z-20 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-10 max-w-3xl mx-auto">
              Profesyonel etkinlikleriniz için son teknoloji görüntü rejisi 
              ve medya server çözümleri
            </p>
                  ...
                  >
                    <div className="group relative overflow-hidden rounded-xl shadow-lg dark:shadow-dark-card h-72">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                        <h3 className="text-white text-xl font-semibold mb-2">Etkinlik Projesi {index}</h3>
                        <p className="text-gray-200">Kurumsal etkinlik için görüntü rejisi ve medya server hizmeti</p>
                      </div>
                    </div>
                  </div>
                ))}
      ...
      {/* İletişim Bölümü */}
      <section id="contact" className="py-20 bg-white dark:bg-dark-background">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#0A1128] dark:text-white mb-4">İletişime Geçin</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Etkinlikleriniz için profesyonel çözümler hakkında bilgi almak veya teklif istemek için formu doldurun.
            </p>
          </div>
          
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="bg-gray-50 dark:bg-dark-card p-8 rounded-xl">
                <h3 className="text-2xl font-semibold text-[#0A1128] dark:text-white mb-6">İletişim Bilgilerimiz</h3>
                <div className="space-y-6">
                  <div className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#0066CC] dark:text-primary-light mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <div>
                      <span className="font-medium block dark:text-white">Adres</span>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <span className="font-medium block dark:text-white">Telefon</span>
                      <span className="text-gray-600 dark:text-gray-300">+90 212 123 4567</span>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#0066CC] dark:text-primary-light mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <span className="font-medium block dark:text-white">E-posta</span>
                      <span className="text-gray-600 dark:text-gray-300">info@skproduction.com</span>
                    </div>
                  </div>
                </div>
              </div>
